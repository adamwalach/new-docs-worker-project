...
- Configure [Session lifespan](/kratos/session-management/10_session-lifespan.mdx)
- Allow users to [access sensitive settings](/kratos/session-management/session-lifespan#privileged-sessions) in their
